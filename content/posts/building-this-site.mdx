---
title: "Building this site — the Milano bridge"
date: "2026-04-16"
tags: ["nextjs", "design"]
description: "Architecture and design choices, warts and all. With Rocket in the vents."
---

Quick tour of how this thing is glued together, in case any of it is useful to you, or in case you're just curious why the homepage has a rocket in it.
...
The hero pane is a real `<canvas>`, not CSS trickery. It runs at 36fps on purpose. 60 felt frantic, 30 felt juddery, 36 is the sweet spot where your eye stops paying attention to it (if you look closely you can tell, but you have to be looking). The columns reset on random intervals instead of synced frames, which is what keeps it from looking like a cheap screensaver. I kept calling the whole thing "warp drive" while building it and eventually the name stuck.
...
- typing `rocket` anywhere on the page runs five seconds of chaos at 2× speed. The toast that pops up says "Blam! Murdered you!", which, if you know, you know.
